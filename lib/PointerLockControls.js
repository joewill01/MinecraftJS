...
THREE.PointerLockControls = function ( camera, domElement ) {
	...
	this.move = function ( x, y, z) {
		...
		let flipVec = vec.clone()
		flipVec.crossVectors( camera.up, flipVec );
		...
		collided_with = mesh_collision_check(vecX.add(flipVecX), player.hitbox)
		...
		collided_with = mesh_collision_check(vecZ.add(flipVecZ), player.hitbox)
		if(!collided_with.collidedWorld){
